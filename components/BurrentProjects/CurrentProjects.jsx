...
import ButtonBlueBorder from '../ButtonBlueBorders';
      ...
      <div className={styles['currentProject_container']}>
        ...
        <div className={styles['block-projects']}>
          ...
          <div className={styles['projects-content']}>
            <h1>ДОПОМОЖИ</h1>
            <h2>
              <span>незахищеним українцям</span>, які страждають від нападу російських окупантів
            </h2>
            <p>
              Ми взяли на себе відповідальність забезпечувати базові потреби тисячі постраждалих людей у «гарячих
              точках» Київської області кожні 6 днів.
            </p>
