...
import { FaEnvelope, FaPhone, FaSkype, FaTwitter, FaDribbble, FaFacebookF } from 'react-icons/fa';
        ...
        <div className="row md-justify-content-center">
          ...
          <div className="col-lg-4 col-md-6 mb-30 mb-lg-0">
            <div className="contact-item">
              ...
              <a className="btn-animation" href="https://www.facebook.com/tortoizthemes">
                Tortoizthemes
              </a>
            </div>
          </div>
